...
# Calculate number of rows that will be stored in the file.
# This depends on the iterations of m and x. LOOK AT THE ITERATION BELOW, FOR A BETTER UNDERSTANDING!
